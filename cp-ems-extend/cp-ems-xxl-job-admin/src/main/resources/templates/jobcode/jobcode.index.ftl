...
<@netCommon.commonScript />
    ...
    <#elseif jobInfo.glueType == "GLUE_energySHELL" >
        <#assign glueTypeModeSrc = "${request.contextPath}/static/plugins/codemirror/mode/energyshell/energyshell.js" />
        <#assign glueTypeIdeMode = "energyshell" />
    </#if>
